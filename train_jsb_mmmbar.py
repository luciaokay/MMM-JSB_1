...
dataset_creator_config = datasetcreatorconfig.JSBDatasetCreatorBarConfig()
...
trainer_config = mmmtrainerconfig.MMMTrainerBaseConfig(
    tokenizer_path = os.path.join("datasets", "jsb_mmmbar", "tokenizer.json"),
    dataset_train_files=[os.path.join("datasets", "jsb_mmmbar", "token_sequences_train.txt")],
    dataset_validate_files=[os.path.join("datasets", "jsb_mmmbar", "token_sequences_valid.txt")],
    pad_length=700,
...
trainer.train(
    output_path=os.path.join("training/jsb_mmmbar"),
